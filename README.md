...
| [Scout Suite](https://github.com/nccgroup/ScoutSuite) ⭐ 7,789 \| 🐛 295 \| 🌐 Python \| 📅 2025-09-23         | Open Source | AWS, Azure, GCP | Multi-cloud security audit with visualized findings and drill-down.                                 |
...
| Tool                                                                                                           | Type        | Clouds | Why It Stands Out                                                                                      |
| -------------------------------------------------------------------------------------------------------------- | ----------- | ------ | ------------------------------------------------------------------------------------------------------ |
| [detect-secrets](https://github.com/Yelp/detect-secrets) ⭐ 4,620 \| 🐛 175 \| 🌐 Python \| 📅 2026-04-02       | Open Source | Multi  | Pre-commit focused secret scanner with baseline workflows for noisy repositories.                      |
| [git-secrets](https://github.com/awslabs/git-secrets) ⭐ 13,371 \| 🐛 131 \| 🌐 Shell \| 📅 2025-09-17          | Open Source | Multi  | Prevents committing AWS credentials and other secret patterns by hooking Git commit and history scans. |
| [GitGuardian ggshield](https://github.com/GitGuardian/ggshield) ⭐ 1,987 \| 🐛 54 \| 🌐 Python \| 📅 2026-08-13 | Freemium    | Multi  | Developer-friendly secret detection in commits and CI pipelines with strong accuracy.                  |
...
| [Clair](https://github.com/quay/clair) ⭐ 11,046 \| 🐛 59 \| 🌐 Go \| 📅 2026-08-11                           | Open Source | Multi  | Performs static vulnerability analysis of container images using continuously ingested CVE feeds across distributions. |
| [Falco](https://falco.org)                                                                                   | Open Source | Multi  | Runtime threat detection for containers and Kubernetes workloads.                                                      |
| [kube-bench](https://github.com/aquasecurity/kube-bench) ⭐ 8,142 \| 🐛 94 \| 🌐 Go \| 📅 2026-08-10          | Open Source | Multi  | Runs CIS Kubernetes benchmark checks against cluster nodes and control planes.                                         |
...
| [Kubescape](https://github.com/kubescape/kubescape) ⭐ 11,640 \| 🐛 134 \| 🌐 Go \| 📅 2026-08-15             | Open Source | Multi  | Kubernetes posture scanner with framework mappings and risk prioritization guidance.                                   |
...
| [Cloud-Nuke](https://github.com/gruntwork-io/cloud-nuke) ⭐ 3,175 \| 🐛 0 \| 🌐 Go \| 📅 2026-07-27                                   | Open Source | AWS             | Deletes cloud resources at scale to enforce clean account baselines and reduce stale attack surface.                  |
...
| [Kubewarden](https://github.com/kubewarden/kubewarden-controller) ⭐ 232 \| 🐛 138 \| 🌐 Rust \| 📅 2026-08-15                        | Open Source | Multi           | Admission policy framework using WebAssembly for portable Kubernetes enforcement.                                     |
| [Kyverno](https://github.com/kyverno/kyverno) ⭐ 8,040 \| 🐛 599 \| 🌐 Go \| 📅 2026-08-14                                            | Open Source | Multi           | Kubernetes-native policy engine for enforceable guardrails and admission controls.                                    |
| [OPA Gatekeeper](https://github.com/open-policy-agent/gatekeeper) ⭐ 4,265 \| 🐛 174 \| 🌐 Go \| 📅 2026-08-10                        | Open Source | Multi           | Enforces OPA policies in Kubernetes through admission control with reusable constraint templates and audit reporting. |
...
| Tool                                                                                              | Type        | Clouds | Why It Stands Out                                                                                        |
| ------------------------------------------------------------------------------------------------- | ----------- | ------ | -------------------------------------------------------------------------------------------------------- |
| [Cosign](https://github.com/sigstore/cosign) ⭐ 6,212 \| 🐛 162 \| 🌐 Go \| 📅 2026-08-14          | Open Source | Multi  | Signs and verifies container images and artifacts to enforce trusted supply chain provenance.            |
...
| [Grype](https://github.com/anchore/grype) ⭐ 12,743 \| 🐛 401 \| 🌐 Go \| 📅 2026-08-14            | Open Source | Multi  | Vulnerability scanner designed to pair directly with generated SBOMs.                                    |
...
| [OSV-Scanner](https://github.com/google/osv-scanner) ⭐ 10,839 \| 🐛 126 \| 🌐 Go \| 📅 2026-08-15 | Open Source | Multi  | Matches open-source dependencies against the OSV vulnerability database for accurate, actionable triage. |
| [Syft](https://github.com/anchore/syft) ⭐ 9,406 \| 🐛 632 \| 🌐 Go \| 📅 2026-08-14               | Open Source | Multi  | Developer-friendly SBOM generator with broad package ecosystem support.                                  |

### Cloud IAM Auditing (16)

| Tool                                                                                                              | Type        | Clouds          | Why It Stands Out                                                                                                    |
| ----------------------------------------------------------------------------------------------------------------- | ----------- | --------------- | -------------------------------------------------------------------------------------------------------------------- |
| [Cartography](https://github.com/lyft/cartography) ⭐ 4,009 \| 🐛 102 \| 🌐 Python \| 📅 2026-08-14                | Open Source | Multi           | Graphs cloud assets and trust relationships to uncover risky access paths.                                           |
| [cloudfox](https://github.com/bishopfox/cloudfox) ⭐ 2,555 \| 🐛 12 \| 🌐 Go \| 📅 2026-05-26                      | Open Source | AWS, Azure, GCP | Enumerates cloud attack paths and identity exposure from an attacker perspective for rapid triage.                   |
| [CloudGoat](https://github.com/RhinoSecurityLabs/cloudgoat) ⭐ 3,694 \| 🐛 23 \| 🌐 Python \| 📅 2026-04-28        | Open Source | AWS             | Purpose-built AWS scenarios for validating detection and IAM attack-path readiness.                                  |
| [Cloudsplaining](https://github.com/salesforce/cloudsplaining) ⭐ 2,243 \| 🐛 28 \| 🌐 JavaScript \| 📅 2026-08-11 | Open Source | AWS             | Identifies risky IAM permissions and privilege-escalation patterns in AWS policies.                                  |
...
| [Stratus Red Team](https://github.com/datadog/stratus-red-team) ⭐ 2,371 \| 🐛 71 \| 🌐 Go \| 📅 2026-08-13        | Open Source | AWS, Azure, GCP | Executes cloud attack emulation scenarios to validate detections and incident response workflows.                    |
