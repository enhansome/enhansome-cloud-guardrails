...
| [Scout Suite](https://github.com/nccgroup/ScoutSuite) ⭐ 7,803 \| 🐛 296 \| 🌐 Python \| 📅 2025-09-23         | Open Source | AWS, Azure, GCP | Multi-cloud security audit with visualized findings and drill-down.                                 |
...
| [KICS](https://github.com/Checkmarx/kics) ⭐ 2,696 \| 🐛 315 \| 🌐 Open Policy Agent \| 📅 2026-08-25                            | Open Source | Multi           | Static analysis engine for Terraform, Kubernetes, and other IaC formats.                                    |
...
| [Clair](https://github.com/quay/clair) ⭐ 11,053 \| 🐛 59 \| 🌐 Go \| 📅 2026-08-25                           | Open Source | Multi  | Performs static vulnerability analysis of container images using continuously ingested CVE feeds across distributions. |
...
| [CloudQuery](https://github.com/cloudquery/cloudquery) ⭐ 6,502 \| 🐛 167 \| 🌐 Go \| 📅 2026-08-29                                  | Open Source | Multi           | Extracts cloud configuration data into SQL tables for policy checks and reporting.                                    |
...
| [Kyverno](https://github.com/kyverno/kyverno) ⭐ 8,083 \| 🐛 649 \| 🌐 Go \| 📅 2026-08-28                                           | Open Source | Multi           | Kubernetes-native policy engine for enforceable guardrails and admission controls.                                    |
| [OPA Gatekeeper](https://github.com/open-policy-agent/gatekeeper) ⭐ 4,269 \| 🐛 187 \| 🌐 Go \| 📅 2026-08-28                       | Open Source | Multi           | Enforces OPA policies in Kubernetes through admission control with reusable constraint templates and audit reporting. |
...
| Tool                                                                                                              | Type        | Clouds          | Why It Stands Out                                                                                                    |
| ----------------------------------------------------------------------------------------------------------------- | ----------- | --------------- | -------------------------------------------------------------------------------------------------------------------- |
| [Cartography](https://github.com/lyft/cartography) ⭐ 4,030 \| 🐛 114 \| 🌐 Python \| 📅 2026-08-28                | Open Source | Multi           | Graphs cloud assets and trust relationships to uncover risky access paths.                                           |
...
| [iam-floyd](https://github.com/udondan/iam-floyd) ⭐ 572 \| 🐛 8 \| 🌐 TypeScript \| 📅 2026-08-29                 | Open Source | AWS             | Generates AWS IAM policies programmatically with a fluent interface to reduce policy authoring mistakes.             |
