...
| [CloudSploit Scans](https://github.com/cloudsploit/scans) ⭐ 3,763 \| 🐛 212 \| 🌐 JavaScript \| 📅 2026-07-28 | Open Source | AWS             | Large set of AWS security checks for identifying cloud misconfigurations at scale.                  |
...
| [Scout Suite](https://github.com/nccgroup/ScoutSuite) ⭐ 7,791 \| 🐛 295 \| 🌐 Python \| 📅 2025-09-23         | Open Source | AWS, Azure, GCP | Multi-cloud security audit with visualized findings and drill-down.                                 |
...
| [CloudFormation Guard](https://github.com/aws-cloudformation/cloudformation-guard) ⭐ 1,385 \| 🐛 52 \| 🌐 Rust \| 📅 2026-08-10 | Open Source | AWS             | Policy-as-code validation for CloudFormation templates to block insecure infrastructure before deployment.  |
| [KICS](https://github.com/Checkmarx/kics) ⭐ 2,686 \| 🐛 326 \| 🌐 Open Policy Agent \| 📅 2026-08-14                            | Open Source | Multi           | Static analysis engine for Terraform, Kubernetes, and other IaC formats.                                    |
...
| Tool                                                                                                           | Type        | Clouds | Why It Stands Out                                                                                      |
| -------------------------------------------------------------------------------------------------------------- | ----------- | ------ | ------------------------------------------------------------------------------------------------------ |
| [detect-secrets](https://github.com/Yelp/detect-secrets) ⭐ 4,621 \| 🐛 176 \| 🌐 Python \| 📅 2026-04-02       | Open Source | Multi  | Pre-commit focused secret scanner with baseline workflows for noisy repositories.                      |
| [git-secrets](https://github.com/awslabs/git-secrets) ⭐ 13,373 \| 🐛 131 \| 🌐 Shell \| 📅 2025-09-17          | Open Source | Multi  | Prevents committing AWS credentials and other secret patterns by hooking Git commit and history scans. |
| [GitGuardian ggshield](https://github.com/GitGuardian/ggshield) ⭐ 1,988 \| 🐛 54 \| 🌐 Python \| 📅 2026-08-13 | Freemium    | Multi  | Developer-friendly secret detection in commits and CI pipelines with strong accuracy.                  |
...
| [Clair](https://github.com/quay/clair) ⭐ 11,047 \| 🐛 59 \| 🌐 Go \| 📅 2026-08-11                           | Open Source | Multi  | Performs static vulnerability analysis of container images using continuously ingested CVE feeds across distributions. |
| [Falco](https://falco.org)                                                                                   | Open Source | Multi  | Runtime threat detection for containers and Kubernetes workloads.                                                      |
| [kube-bench](https://github.com/aquasecurity/kube-bench) ⭐ 8,144 \| 🐛 94 \| 🌐 Go \| 📅 2026-08-10          | Open Source | Multi  | Runs CIS Kubernetes benchmark checks against cluster nodes and control planes.                                         |
| [kube-hunter](https://github.com/aquasecurity/kube-hunter) ⭐ 5,076 \| 🐛 82 \| 🌐 Python \| 📅 2024-03-19    | Open Source | Multi  | Performs active reconnaissance to identify exposed Kubernetes security weaknesses.                                     |
| [Kubescape](https://github.com/kubescape/kubescape) ⭐ 11,646 \| 🐛 138 \| 🌐 Go \| 📅 2026-08-16             | Open Source | Multi  | Kubernetes posture scanner with framework mappings and risk prioritization guidance.                                   |
| [Trivy Operator](https://github.com/aquasecurity/trivy-operator) ⭐ 1,923 \| 🐛 207 \| 🌐 Go \| 📅 2026-08-09 | Open Source | Multi  | Brings continuous vulnerability and configuration scanning into Kubernetes clusters.                                   |

### Compliance as Code (11)

| Tool                                                                                                                                 | Type        | Clouds          | Why It Stands Out                                                                                                     |
| ------------------------------------------------------------------------------------------------------------------------------------ | ----------- | --------------- | --------------------------------------------------------------------------------------------------------------------- |
| [Automated Security Helper (ASH)](https://github.com/awslabs/automated-security-helper) ⭐ 677 \| 🐛 36 \| 🌐 Python \| 📅 2026-08-12 | Open Source | AWS             | Runs multiple code and IaC security scanners in isolated containers with one aggregated security report.              |
...
| [CloudQuery](https://github.com/cloudquery/cloudquery) ⭐ 6,481 \| 🐛 164 \| 🌐 Go \| 📅 2026-08-15                                   | Open Source | Multi           | Extracts cloud configuration data into SQL tables for policy checks and reporting.                                    |
...
| [Kubewarden](https://github.com/kubewarden/kubewarden-controller) ⭐ 232 \| 🐛 138 \| 🌐 Rust \| 📅 2026-08-16                        | Open Source | Multi           | Admission policy framework using WebAssembly for portable Kubernetes enforcement.                                     |
| [Kyverno](https://github.com/kyverno/kyverno) ⭐ 8,041 \| 🐛 600 \| 🌐 Go \| 📅 2026-08-14                                            | Open Source | Multi           | Kubernetes-native policy engine for enforceable guardrails and admission controls.                                    |
| [OPA Gatekeeper](https://github.com/open-policy-agent/gatekeeper) ⭐ 4,265 \| 🐛 177 \| 🌐 Go \| 📅 2026-08-10                        | Open Source | Multi           | Enforces OPA policies in Kubernetes through admission control with reusable constraint templates and audit reporting. |
...
| Tool                                                                                              | Type        | Clouds | Why It Stands Out                                                                                        |
| ------------------------------------------------------------------------------------------------- | ----------- | ------ | -------------------------------------------------------------------------------------------------------- |
| [Cosign](https://github.com/sigstore/cosign) ⭐ 6,215 \| 🐛 162 \| 🌐 Go \| 📅 2026-08-14          | Open Source | Multi  | Signs and verifies container images and artifacts to enforce trusted supply chain provenance.            |
...
| [Grype](https://github.com/anchore/grype) ⭐ 12,748 \| 🐛 403 \| 🌐 Go \| 📅 2026-08-14            | Open Source | Multi  | Vulnerability scanner designed to pair directly with generated SBOMs.                                    |
...
| [OSV-Scanner](https://github.com/google/osv-scanner) ⭐ 10,840 \| 🐛 126 \| 🌐 Go \| 📅 2026-08-17 | Open Source | Multi  | Matches open-source dependencies against the OSV vulnerability database for accurate, actionable triage. |
| [Syft](https://github.com/anchore/syft) ⭐ 9,407 \| 🐛 633 \| 🌐 Go \| 📅 2026-08-14               | Open Source | Multi  | Developer-friendly SBOM generator with broad package ecosystem support.                                  |

### Cloud IAM Auditing (16)

| Tool                                                                                                              | Type        | Clouds          | Why It Stands Out                                                                                                    |
| ----------------------------------------------------------------------------------------------------------------- | ----------- | --------------- | -------------------------------------------------------------------------------------------------------------------- |
| [Cartography](https://github.com/lyft/cartography) ⭐ 4,009 \| 🐛 101 \| 🌐 Python \| 📅 2026-08-14                | Open Source | Multi           | Graphs cloud assets and trust relationships to uncover risky access paths.                                           |
...
| [CloudGoat](https://github.com/RhinoSecurityLabs/cloudgoat) ⭐ 3,697 \| 🐛 23 \| 🌐 Python \| 📅 2026-04-28        | Open Source | AWS             | Purpose-built AWS scenarios for validating detection and IAM attack-path readiness.                                  |
...
| [iam-floyd](https://github.com/udondan/iam-floyd) ⭐ 573 \| 🐛 8 \| 🌐 TypeScript \| 📅 2026-08-15                 | Open Source | AWS             | Generates AWS IAM policies programmatically with a fluent interface to reduce policy authoring mistakes.             |
...
| [Peirates](https://github.com/inguardians/peirates) ⭐ 1,471 \| 🐛 25 \| 🌐 Go \| 📅 2026-07-03                    | Open Source | AWS             | Simulates common Kubernetes-to-cloud privilege escalation paths in AWS environments.                                 |
...
| [Stratus Red Team](https://github.com/datadog/stratus-red-team) ⭐ 2,372 \| 🐛 72 \| 🌐 Go \| 📅 2026-08-13        | Open Source | AWS, Azure, GCP | Executes cloud attack emulation scenarios to validate detections and incident response workflows.                    |
